...
<div id="content">
	...
	<div style="" class="menu">
		...
		<div class="categories">
			<nav>
				<form method="post" id="categories" action="/Site/search">
				<ul style="font-size: 0.9vw;">
					<li><input type="submit" name="categories" value="Sports"></li>
					<li><input type="submit" name="categories" value="Electronics"></li>
					<li><input type="submit" name="categories" value="Outdoors"></li>
					<li><input type="submit" name="categories" value="Toys"></li>
					<li><input type="submit" name="categories" value="Arts"></li>
					<li><input type="submit" name="categories" value="Garden"></li>
				</ul>
			</nav>
			</form>
		</div>
